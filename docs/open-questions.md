...
2. Phase 2 的首要价值是什么
   是“更好的 briefing generation”，因为“source access”已经比较成熟了

3. 是否需要维护公共资源目录之外的私有接入层
   很多真正高价值的信息源可能依赖用户自己的账号和订阅。
   需要的，所以我们接入了bb-browser之类的工具，这样可以无缝访问用户自己的source
...
3. 什么时候引入缓存
   ...
   我们选择了缓存，因为缓存可以减少重复计算，提高效率。但这个只适用于非个性化的内容。

## 风险问题

1. 个性化是不是会把系统做偏
   如果太早强调个性化，很容易走向隐式画像和信息茧房。
   我们选择了个性化，非个性化的内容已经有存量的了
...
3. 这个项目和 RSSHub / Readwise / Inoreader 的差异是否足够大
   ...
   我们选择了 Agent-first 的 processing layer
